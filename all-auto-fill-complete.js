...
(function() {
    ...
    function verificarPaginaActual() {
        ...
        if (document.querySelector('[aria-describedby*="rc83969ce60c842f5adeb84b5bffc55fd"]')) {
            ...
            console.log("📍 Página actual detectada: 3 (Evaluación Personal 1-8)");
        } else if (document.querySelector('[aria-labelledby*="r0de2eedf33a0412db398c86ba0f457e3"]')) {
            estadoFormulario.paginaActual = 4;
            console.log("📍 Página actual detectada: 4 (Evaluación Personal 9-16)");
        } else if (document.querySelector('[aria-labelledby*="ra1e542d89d0a4c3daa2f6f997a367c93"]')) {
            estadoFormulario.paginaActual = 5;
            console.log("📍 Página actual detectada: 5 (Evaluación Final)");
        } else {
    ...
    console.log("   automacionMedica.llenarPagina(2-5) - Llenar página específica");
